...
int main() {
	...
	// Create a separator.
	auto separator = sfg::Separator::Create( sfg::Separator::Orientation::VERTICAL );
	...
	auto btn2align = sfg::Button::Create(" lolololo ");
	alignment2->Add( btn2align );
	...
	alignment2->SetAlignment(sf::Vector2f(0.6f , 0.4f ));
	// Create our frame.
	...
	alignment_box->Pack( alignment2, true, true );
